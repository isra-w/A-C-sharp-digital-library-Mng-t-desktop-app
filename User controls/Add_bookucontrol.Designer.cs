namespace d_labdemo.User_controls
{
    partial class Add_bookucontrol
    {
        ...
        private void InitializeComponent()
        {
            ...
            Adducontrol_booknamelbl = new Label();
            ...
            Adducontrol_booknameBX = new TextBox();
            ...
            // 
            // Adducontrol_booknamelbl
            // 
            Adducontrol_booknamelbl.AutoSize = true;
            Adducontrol_booknamelbl.Location = new Point(121, 127);
            Adducontrol_booknamelbl.Name = "Adducontrol_booknamelbl";
            Adducontrol_booknamelbl.Size = new Size(91, 21);
            Adducontrol_booknamelbl.TabIndex = 1;
            Adducontrol_booknamelbl.Text = "Book Name";
            Adducontrol_booknamelbl.TextAlign = ContentAlignment.MiddleCenter;
            // 
            // Adducontrol_authornamelbl
            // 
            Adducontrol_authornamelbl.AutoSize = true;
            Adducontrol_authornamelbl.Location = new Point(121, 190);
            ...
            Adducontrol_formatlbl.Location = new Point(121, 309);
            ...
            Adducontrol_catagorylbl.Location = new Point(121, 251);
            ...
            Adducontrol_addbtn.Location = new Point(285, 392);
            ...
            // 
            // Adducontrol_booknameBX
            // 
            Adducontrol_booknameBX.Location = new Point(313, 127);
            Adducontrol_booknameBX.Name = "Adducontrol_booknameBX";
            Adducontrol_booknameBX.Size = new Size(270, 29);
            Adducontrol_booknameBX.TabIndex = 6;
            // 
            // Adducontrol_authornameBX
            // 
            Adducontrol_authornameBX.Location = new Point(313, 190);
            ...
            Adducontrol_catagorycbx.Location = new Point(313, 251);
            ...
            Adducontrol_formatcbx.Location = new Point(313, 309);
            ...
            Controls.Add(Adducontrol_booknameBX);
            ...
            Controls.Add(Adducontrol_booknamelbl);
            Controls.Add(Add_bookucontrollbl);
            Name = "Add_bookucontrol";
            Size = new Size(786, 458);
            ResumeLayout(false);
            PerformLayout();
        }
        ...
        private Label Adducontrol_booknamelbl;
        ...
        private TextBox Adducontrol_booknameBX;
